...
#define ENCODER_QUADDEC                 (TIM3_ENCODER)                          // 正交编码器对应使用的编码器接口 这里使用 TIM3 的编码器功能
#define ENCODER_QUADDEC_A               (TIM3_ENCODER_CH1_B4)                   // A 相对应的引脚
#define ENCODER_QUADDEC_B               (TIM3_ENCODER_CH2_B5)                   // B 相对应的引脚

#define ENCODER_DIR		                (TIM4_ENCODER)                          // 带方向编码器对应使用的编码器接口 这里使用 TIM4 的编码器功能
#define ENCODER_DIR_PULSE               (TIM4_ENCODER_CH1_B6)                   // PULSE 对应的引脚
#define ENCODER_DIR_DIR                 (TIM4_ENCODER_CH2_B7)                   // DIR 对应的引脚
